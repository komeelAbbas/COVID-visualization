      ...
      # while self.mapHash.get ( key ) == None :
        ...
        with csv_generator_lock :
          ...
          if key not in csvHash:
            ...
            with open( os.path.abspath('./cowiz/usmap/csvLayers/Covid19Period.conf'), 'r' ) as fp :
            ...
            with open( os.path.abspath('./cowiz/usmap/csvLayers/Covid19Period.conf'), 'w' ) as fp :
              fp.writelines(allLines)
            fp.close()

            subprocess.call([os.path.abspath('./cowiz/usmap/csvLayers/csvGenerator')], 
